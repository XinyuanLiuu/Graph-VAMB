...
for nepoch in nepoch_list:
    for gamma in gamma_list:
        for lrate in lrate_list:
            LATENT_PATH = 'graph/{}/errorfree/latent_{}_{}_{}_{}_{}.npz'.format(dataset,dataset,date,nepoch,gamma,lrate)
            ...
            with open('graph/{}/errorfree/ratios_{}_{}_{}_{}.json'.format(dataset,date,nepoch,gamma,lrate), 'w') as f:
                json.dump(ratios, f)
