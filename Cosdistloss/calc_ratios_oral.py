...
date = '0512'
beta_list = [230]
gamma_list = [1e-4,0.001,0.01,0.02]
...
for beta in beta_list:
    for gamma in gamma_list:
        for lrate in lrate_list:
            LATENT_PATH = 'graph/{}/errorfree/latent_{}_{}_{}_{}_{}.npz'.format(dataset,dataset,date,beta,gamma,lrate)
            ...
            with open('graph/{}/errorfree/ratios_{}_{}_{}_{}.json'.format(dataset,date,beta,gamma,lrate), 'w') as f:
                json.dump(ratios, f)
